...
import { ReduxDevtoolsExtensionConnection,
  ReduxDevtoolsExtension, ReduxDevtoolsExtensionConfig } from '@ngrx/store-devtools/src/extension';

export const REMOTE_DEVTOOLS_PROXY_OPTIONS = new
InjectionToken<RemoteDevToolsProxyOptions>('RemoteDevToolsProxyOptions');
